...
import (
    ...
    "github.com/Sectran/sectran_admin/model/{{.Package}}"
    "github.com/Sectran/sectran_admin/model/common/request"
    {{.Package}}Req "github.com/Sectran/sectran_admin/model/{{.Package}}/request"
    "github.com/Sectran/sectran_admin/model/common/response"
    "github.com/Sectran/sectran_admin/service"
