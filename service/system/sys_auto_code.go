...
import (
	...
	ast2 "github.com/Sectran/sectran_admin/utils/ast"

	"github.com/Sectran/sectran_admin/resource/autocode_template/subcontract"
	cp "github.com/otiai10/copy"
	"go.uber.org/zap"

	"github.com/Sectran/sectran_admin/global"
	"github.com/Sectran/sectran_admin/model/system"
	"github.com/Sectran/sectran_admin/utils"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/Sectran/sectran_admin/%s/%s",
			packageNameF: "%s",
...
func installation(path string, formPath string, toPath string) error {
	...
	return cp.Copy(form, to, cp.Options{})
}
