...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "lables", Type: field.TypeString, Nullable: true, Comment: "account lable ids|账号标签ID集合"},
	...
	LableTreesColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeUint, Comment: "lable type|标签类型"},
		...
		{Name: "parent_lable", Type: field.TypeUint64, Comment: "parent lable id|父标签id"},
		{Name: "lable_target_type", Type: field.TypeUint16, Comment: "lable target type|标签目标类型"},
		{Name: "parent_lables", Type: field.TypeString, Comment: "parent lables id,split by ','|父标签id集合升序排列,逗号分隔"},
		{Name: "lable_owner", Type: field.TypeUint64, Comment: "lable owner,user ID|标签所属者,用户ID"},
		{Name: "inherit", Type: field.TypeBool, Comment: "child lable can inherit parents|标签是否可以继承"},
		{Name: "related_lables", Type: field.TypeString, Comment: "related labels id,split by ','|关联标签id集合升序排列,逗号分隔"},
		{Name: "description", Type: field.TypeString, Size: 256, Comment: "label description|标签描述"},
		{Name: "ext1", Type: field.TypeString, Comment: "label extented|标签拓展"},
		{Name: "ext2", Type: field.TypeString, Comment: "label extented|标签拓展"},
	}
