...
func init() {
	...
	// accountDescPrivateKeyPassword is the schema descriptor for private_key_password field.
	accountDescPrivateKeyPassword := accountFields[5].Descriptor()
	// account.PrivateKeyPasswordValidator is a validator for the "private_key_password" field. It is called by the builders before save.
	account.PrivateKeyPasswordValidator = accountDescPrivateKeyPassword.Validators[0].(func(string) error)
	// accountDescDeviceID is the schema descriptor for device_id field.
	accountDescDeviceID := accountFields[6].Descriptor()
	...
	// accountDescDepartmentID is the schema descriptor for department_id field.
	accountDescDepartmentID := accountFields[7].Descriptor()
	// account.DepartmentIDValidator is a validator for the "department_id" field. It is called by the builders before save.
	account.DepartmentIDValidator = accountDescDepartmentID.Validators[0].(func(uint64) error)
